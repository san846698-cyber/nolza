...
export const GUIDES: GuidePage[] = [
  {
    ...
    what:
      "nolza.fun의 반응속도 게임은 5번의 시도를 평균으로 묶어 한 번의 결과를 보여줍니다. 너무 빨리 누르면 해당 라운드는 다시 시작되기 때문에, 빠른 손보다 정확한 타이밍이 먼저 필요합니다.",
    how:
  ...
  },
  {
    ...
    intro: [
      ...
      "nolza.fun에서는 심리 테스트, 관계 테스트, 운세형 결과, 미니게임을 기분과 상황에 맞게 골라 짧게 즐길 수 있습니다.",
    ],
    what:
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "nolza.fun의 결과는 엔터테인먼트로 읽는 것이 좋습니다. 전문 조언이 아니라 대화 소재라고 생각하면 더 편하게 즐길 수 있습니다.",
      },
      {
