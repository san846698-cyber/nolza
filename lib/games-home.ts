...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    type: "test", category: "tests",
    palette: P.paperGold, font: "serif", thumb: "/thumbnails-generated/scene-choice.png",
  ...
  },
  {
    ...
    ko: { title: "나를 차갑게 만드는 순간", sub: "평소의 내가 차갑게 변하는 지점은 어디일까?", kicker: "심리 테스트" },
    en: { title: "The Moment I Turn Cold", sub: "What makes your usual self become colder or more distant?", kicker: "Psychology Test" },
    type: "test", category: "tests",
    palette: P.paperGold, font: "serif", thumb: "/thumbnails-generated/breaking-point.png",
  ...
  },
  {
    ...
    skin: "block", tone: 3, labels: ["new", "quick", "share"], duration: { ko: "9문항 · 약 2분", en: "9 questions · about 2 min" },
  },
  {
    id: "valorant-playstyle", href: "/tests/valorant-playstyle", cat: "self", no: "VAL",
    ko: { title: "발로란트 플레이 성향 테스트", sub: "에임이냐 머리냐, 너의 진짜 발로 스타일. 9문항으로 알아보는 내 에이전트 유형", kicker: "게임 성향 테스트" },
    en: { title: "Valorant Playstyle Test", sub: "Aim or brain? Find your real Valorant agent type in 9 questions", kicker: "Game playstyle test" },
    type: "test", category: "tests",
    palette: P.judgment, font: "sans",
    skin: "block", tone: 3, labels: ["new", "quick", "share"], duration: { ko: "9문항 · 약 2분", en: "9 questions · about 2 min" },
  },
  {
    id: "overwatch-playstyle", href: "/tests/overwatch-playstyle", cat: "self", no: "OW",
    ko: { title: "오버워치 플레이 성향 테스트", sub: "탱·딜·힐, 너의 진짜 옵치 스타일. 9문항으로 알아보는 내 영웅 유형", kicker: "게임 성향 테스트" },
    en: { title: "Overwatch Playstyle Test", sub: "Tank, damage, or support? Find your real Overwatch hero type in 9 questions", kicker: "Game playstyle test" },
    type: "test", category: "tests",
    palette: P.deepSea, font: "sans",
    skin: "block", tone: 3, labels: ["new", "quick", "share"], duration: { ko: "9문항 · 약 2분", en: "9 questions · about 2 min" },
  },
  {
    id: "pubg-playstyle", href: "/tests/pubg-playstyle", cat: "self", no: "PUBG",
    ko: { title: "배그 플레이 성향 테스트", sub: "핫드랍이냐 존버냐, 너의 진짜 배그 스타일. 9문항으로 알아보는 내 플레이 유형", kicker: "게임 성향 테스트" },
    en: { title: "PUBG Playstyle Test", sub: "Hot-drop or hide? Find your real PUBG play type in 9 questions", kicker: "Game playstyle test" },
    type: "test", category: "tests",
    palette: P.emberDark, font: "sans",
    skin: "block", tone: 4, labels: ["new", "quick", "share"], duration: { ko: "9문항 · 약 2분", en: "9 questions · about 2 min" },
  },
  {
    id: "lck-pro", href: "/tests/lck-pro", cat: "self", no: "LCK",
    ko: { title: "LCK 프로게이머 성향 테스트", sub: "포지션 고르고 5문항! 너랑 닮은 LCK 선수는? 25명 중 한 명", kicker: "e스포츠 성향 테스트" },
    en: { title: "LCK Pro Player Test", sub: "Pick your role, answer 5 — which LCK pro are you? 1 of 25", kicker: "Esports persona test" },
    type: "test", category: "tests",
    palette: P.cosmos, font: "sans",
    skin: "block", tone: 3, labels: ["new", "quick", "share"], duration: { ko: "약 1분", en: "1 min" },
  },
