...
const TRUST_CONTENT: Record<TrustPageId, Record<SimpleLocale, TrustContent>> = {
      ...
      sections: [
        {
          title: "우리는 무엇을 만드나요?",
          paragraphs: [
            "놀자.fun은 웹게임, 심리 테스트, 궁합 테스트, 문화 퀴즈, 시뮬레이션, 운세형 엔터테인먼트 등 다양한 인터랙티브 웹 경험을 제공하는 사이트입니다.",
            "놀자.fun은 Studio4Any에서 운영합니다. Studio4Any는 설치 없이 브라우저에서 쉽고 빠르게 즐길 수 있는 가벼운 웹 경험을 만드는 것을 목표로 합니다.",
          ],
        },
        {
          title: "콘텐츠 방향",
          paragraphs: [
            ...
            "놀자.fun의 테스트, 궁합, 운세형 콘텐츠는 재미와 자기이해를 위한 엔터테인먼트입니다. 실제 판단, 전문적인 조언, 의학적·법률적·재정적 조언을 대체하지 않습니다.",
          ],
        },
        {
          title: "운영자 정보",
  ...
  privacy: {
    ko: {
      eyebrow: "개인정보",
      title: "개인정보처리방침",
      subtitle: "놀자.fun은 사용자의 개인정보 보호를 중요하게 생각합니다.",
      sections: [
        {
          title: "1. 소개",
          paragraphs: [
            "놀자.fun은 웹게임, 테스트, 시뮬레이션, 인터랙티브 콘텐츠를 제공하는 엔터테인먼트 사이트입니다. 본 개인정보처리방침은 사이트 이용 중 어떤 정보가 처리될 수 있는지 설명합니다.",
          ],
        },
        {
          title: "2. 수집될 수 있는 정보",
          paragraphs: [
            "놀자.fun은 대부분의 콘텐츠를 회원가입 없이 이용할 수 있도록 설계되어 있습니다. 다만 사이트 운영, 보안, 분석, 광고 제공을 위해 브라우저 종류, 기기 정보, 방문한 페이지, 대략적인 지역, 이용 시간, 상호작용 정보 등이 처리될 수 있습니다.",
        ...
        },
        {
          title: "3. 쿠키",
          paragraphs: [
            "놀자.fun은 사이트 기능 개선, 사용자 환경 최적화, 트래픽 분석, 광고 제공을 위해 쿠키 또는 유사 기술을 사용할 수 있습니다. 사용자는 브라우저 설정을 통해 쿠키를 제한하거나 비활성화할 수 있습니다.",
          ],
        },
        {
          title: "4. Google AdSense 및 제3자 광고",
          paragraphs: [
            "놀자.fun은 Google AdSense 또는 기타 제3자 광고 서비스를 통해 광고를 표시할 수 있습니다. Google을 포함한 제3자 광고 제공업체는 쿠키를 사용하여 사용자의 이전 방문 기록을 기반으로 광고를 제공할 수 있습니다.",
        ...
        },
        {
          title: "5. 분석 도구",
          paragraphs: [
            "놀자.fun은 방문자 수, 페이지 이용 방식, 콘텐츠 성과를 이해하고 서비스를 개선하기 위해 분석 도구를 사용할 수 있습니다.",
          ],
        },
        {
          title: "6. 엔터테인먼트 콘텐츠",
          paragraphs: [
            "놀자.fun의 테스트, 궁합, 운세형 콘텐츠, 시뮬레이션, 게임은 재미와 자기이해를 위한 콘텐츠입니다. 이는 전문적인 조언이나 진단을 대체하지 않습니다.",
          ],
        },
        {
          title: "7. 정보 공유",
          paragraphs: [
            "놀자.fun은 사용자의 개인정보를 판매하지 않습니다. 다만 호스팅, 분석, 광고, 보안 등 서비스 운영에 필요한 범위에서 제3자 서비스 제공업체가 일부 기술 정보를 처리할 수 있습니다.",
          ],
        },
        {
          title: "8. 아동 개인정보",
          paragraphs: [
            "놀자.fun은 일반 이용자를 대상으로 하며, 고의로 아동의 개인정보를 수집하지 않습니다. 보호자가 아동의 개인정보가 제공되었다고 판단하는 경우, 문의 이메일을 통해 삭제를 요청할 수 있습니다.",
          ],
        },
        {
          title: "9. 문의",
  ...
  terms: {
    ko: {
      eyebrow: "이용약관",
      title: "이용약관",
      subtitle: "놀자.fun을 이용하기 전에 아래 내용을 확인해주세요.",
      sections: [
        {
          title: "1. 약관 동의",
          paragraphs: ["놀자.fun을 이용함으로써 사용자는 본 이용약관에 동의한 것으로 간주됩니다."],
        },
        {
          title: "2. 서비스 목적",
          paragraphs: [
            "놀자.fun은 웹게임, 테스트, 시뮬레이션, 궁합, 운세형 콘텐츠, 기타 인터랙티브 엔터테인먼트 콘텐츠를 제공합니다.",
          ],
        },
        {
          title: "3. 엔터테인먼트 목적",
          paragraphs: [
            "놀자.fun의 콘텐츠는 재미와 자기이해를 위한 것입니다. 테스트 결과, 궁합, 운세형 콘텐츠, 시뮬레이션 결과는 실제 판단이나 전문적인 조언을 대체하지 않습니다.",
          ],
        },
        {
          title: "4. 전문적 조언 아님",
          paragraphs: [
            "놀자.fun은 법률, 의료, 심리, 재정, 투자, 연애, 기타 전문적인 조언을 제공하지 않습니다. 중요한 결정은 관련 전문가와 상담하거나 신중하게 판단해야 합니다.",
          ],
        },
        {
          title: "5. 사용자 책임",
        ...
        },
        {
          title: "6. 지식재산권",
          paragraphs: [
            "놀자.fun의 오리지널 콘텐츠, 디자인, 문구, 그래픽, 인터랙티브 경험은 별도 표시가 없는 한 사이트 또는 운영자에게 권리가 있습니다. 무단 복제, 배포, 상업적 이용은 금지됩니다.",
          ],
        },
        {
          title: "7. 제3자 서비스 및 광고",
          paragraphs: [
            "놀자.fun은 호스팅, 분석, 광고 등 서비스 운영을 위해 제3자 서비스를 사용할 수 있으며, Google AdSense 등 광고 네트워크를 통해 광고를 표시할 수 있습니다.",
          ],
        },
        {
          title: "8. 면책",
          paragraphs: [
            "놀자.fun은 서비스를 가능한 안정적으로 제공하기 위해 노력하지만, 모든 콘텐츠의 정확성, 완전성, 적합성을 보장하지 않습니다. 서비스는 현재 제공되는 상태 그대로 제공됩니다.",
          ],
        },
        {
          title: "9. 약관 변경",
