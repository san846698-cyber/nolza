...
export default function PoliticalTypeMotif({ skin }: { skin: Skin }) {
  ...
  return (
    <svg viewBox="0 0 160 100" className="h-full w-full" fill="none" aria-hidden>
      ...
      <text x="24" y="50" textAnchor="middle" fill="#0f766e" fontSize="6" fontWeight="900" opacity="0.82">L</text>
      <text x="136" y="50" textAnchor="middle" fill="#a16207" fontSize="6" fontWeight="900" opacity="0.82">R</text>
      ...
      <circle cx="25" cy="18" r="4" fill="#0f766e" opacity="0.75" />
      <circle cx="137" cy="86" r="4" fill="#a16207" opacity="0.75" />
    </svg>
  );
}
