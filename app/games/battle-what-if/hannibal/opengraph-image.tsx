...
import { AXIS_LABEL, decodePicks, evaluate, type Axis } from "@/lib/hannibal";

export const alt = "한니발이라면 — 당신의 지휘 성향";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <div style={{ display: "flex" }}>한니발이라면 · 지휘 성향</div>
