...
import { AXIS_LABEL, decodePicks, evaluate, type Axis } from "@/lib/hansando";

export const alt = "이순신이라면 — 당신의 지휘 성향";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <div style={{ display: "flex" }}>이순신이라면 · 한산도대첩</div>
