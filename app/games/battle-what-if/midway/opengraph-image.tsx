...
import { AXIS_LABEL, decodePicks, evaluate, type Axis } from "@/lib/midway";

export const alt = "니미츠라면 — 당신의 지휘 성향";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <div style={{ display: "flex" }}>니미츠라면 · 미드웨이</div>
