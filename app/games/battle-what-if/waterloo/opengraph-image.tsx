...
import { AXIS_LABEL, decodePicks, evaluate, type Axis } from "@/lib/waterloo";

export const alt = "나폴레옹이라면 — 당신의 지휘 성향";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <div style={{ display: "flex" }}>나폴레옹이라면 · 워털루</div>
